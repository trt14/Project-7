    ...
    return SafeArea(
      child: BlocProvider(
        ...
        child: Builder(builder: (context) {
          final addMemberToProject = context.read<ProjectCubit>();
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style:
                          TextStyle(color: color.txtBlack45Color, fontSize: 14),
                    ),
                  ),
                  Divider(
                    thickness: 0.5,
                  ...
                  Container(
                      ...
                      child: Text(
                        "My team",
                        style:
                            TextStyle(color: color.txtwhiteColor, fontSize: 25),
                      )),
                  Container(
                      ...
                      children: [
                        Container(
                          ...
                          child: BlocBuilder<ProjectCubit, ProjectState>(
                            builder: (context, state) {
                              if (state is SuccessMemberProjectState ||
                                  state is ProjectInitial ||
                                  state is ErrorMemberProjectState) {
                        ...
                        IconButton(
                            onPressed: () async {
                              // customAlert(context);
                              // userProject =
                              //     await addMemberToProject.addMemberEvent(
...
Future<void> addNewMembers(BuildContext context) {
  return showDialog<void>(
    context: context,
    builder: (BuildContext context) {
      return AlertDialog(
